...
const ApexPieChart = dynamic(
    () => import('@/components/shared/charts/ApexPieChart'),
    {
        ssr: false,
    }
)
...
function TeamStatisticsResults({
    teamStatistics,
    divResultsRef,
}: ITeamStatisticsResultsProps): JSX.Element {
    return (
        <div
        ...
        >
            <div className='px-4 py-4 bg-white rounded-lg shadow-lg flex flex-col'>
                ...
                <ResultsDataTable data={teamStatistics.resultsTable} />
            </div>
            <div className='px-4 py-4 bg-white rounded-lg shadow-lg flex flex-col'>
                <h2 className='text-2xl font-bold leading-6 text-emerald-900 my-6'>
                    Lista de jogadores
                ...
                <div className='flex-grow flex'>
                    <PlayersList players={teamStatistics.players} />
                </div>
            </div>
            <div className='px-4 py-4 bg-white rounded-lg shadow-lg flex flex-col'>
                <h2 className='text-2xl font-bold leading-6 text-emerald-900 my-6'>
            ...
            <div className='px-4 py-4 bg-white rounded-lg shadow-lg flex flex-col'>
                ...
                <span className='flex-grow flex items-center justify-center'>
                    <ApexPieChart
                        ...
                        labelsKey='minute'
                        responsiveHeight={['300px', '250px', '250px', '300px']}
                        ...
                        responsiveWidth={['100%', '100%', '100%', '350px']}
                        seriesKey='goals'
                        width='350px'
                    />
                </span>
